...
const prefixCls = utils.createPrefixCls('shape-element-operate', styles, 'ppt');

export interface ShapeElementOperateProps {
  className?: string;
...
const ShapeElementOperate: React.FC<ShapeElementOperateProps> = (props) => {
  const {
    elementInfo,
    className,
    style,
